...
import stylesCss from 'themes/moonstarbooking/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinPasswordFieldCss from 'themes/moonstarbooking/components/vaadin-password-field.css';
import vaadinTextAreaCss from 'themes/moonstarbooking/components/vaadin-text-area.css';
import vaadinTextFieldCss from 'themes/moonstarbooking/components/vaadin-text-field.css';

window.Vaadin = window.Vaadin || {};
window.Vaadin['_vaadintheme_moonstarbooking_globalCss'] = window.Vaadin['_vaadintheme_moonstarbooking_globalCss'] || [];
export const applyTheme = (target) => {
  
  const injectGlobal = (window.Vaadin['_vaadintheme_moonstarbooking_globalCss'].length === 0) || (!window.Vaadin['_vaadintheme_moonstarbooking_globalCss'].includes(target) && target !== document);
  if (injectGlobal) {
    injectGlobalCss(stylesCss.toString(), target);
    
    window.Vaadin['_vaadintheme_moonstarbooking_globalCss'].push(target);
  }
  if (!document['_vaadintheme_moonstarbooking_componentCss']) {
    registerStyles(
    ...
    document['_vaadintheme_moonstarbooking_componentCss'] = true;
  }
